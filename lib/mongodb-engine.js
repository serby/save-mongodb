...
function createEngine(collection, engineOptions) {
  ...
  function update(object, overwrite, callback) {
    ...
    var typedId = castIdProperty(query)
    collection.findAndModify(typedId, [ [ '_id', 'asc' ] ], updateData, { 'new': true }, function (error, entity) {
  ...
  function count(query, callback) {
    ...
    collection.count(castIdProperty(query), callback)
  }
